...
@section('header-title', 'Edit Ekstrakurikuler')

@section('content')
<form action="{{ route('ekskul.update', $ekskul->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-6 md:p-8 max-w-2xl mx-auto">
    @csrf
    @method('PUT')
    <div class="space-y-8">
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="nama_ekskul" id="nama_ekskul" value="{{ old('nama_ekskul', $ekskul->nama_ekskul) }}" required
        ...
        <div>
            ...
            <div class="mt-2">
                <textarea id="deskripsi" name="deskripsi" rows="4"
                          ...
                          placeholder="Jelaskan sedikit tentang kegiatan ini...">{{ old('deskripsi', $ekskul->deskripsi) }}</textarea>
            </div>
        </div>
