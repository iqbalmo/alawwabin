...
@section('title', 'Tambah Siswa Baru | SITU Al-Awwabin')

@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-[#2C5F2D]">Formulir Siswa Baru</h1>
            <p class="mt-2 text-gray-600">Lengkapi data di bawah ini untuk mendaftarkan siswa baru.</p>
        </div>
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 gap-x-6 gap-y-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <select id="status_mukim" name="status_mukim"
                                class="block w-full rounded-lg border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6 transition-shadow">
                                <option value="">-- Pilih --</option>
                                <option value="MUKIM" {{ old('status_mukim') == 'MUKIM' ? 'selected' : '' }}>MUKIM</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="text" name="sekolah_asal" id="sekolah_asal" value="{{ old('sekolah_asal') }}"
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-6 md:grid-cols-2">
                            <div class="md:col-span-2">
                                ...
                                <textarea id="alamat_orangtua" name="alamat_orangtua" rows="3"
                                    class="mt-2 block w-full rounded-lg border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6 transition-shadow">{{ old('alamat_orangtua') }}</textarea>
                            </div>
                            <div>
