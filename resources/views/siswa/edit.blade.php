...
{{-- 
  Catatan: 
  - $siswa adalah variabel data siswa yang dikirim dari SiswaController@edit
  - $kelas adalah variabel daftar semua kelas yang dikirim dari SiswaController@edit
--}}

<form action="{{ route('siswa.update', $siswa->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-6 md:p-8">
    @csrf
    ...
    <div class="space-y-12">
        ...
        <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-2xl font-bold tracking-tight text-[#2C5F2D]">Formulir Edit Siswa</h2>
            <p class="mt-2 text-sm text-gray-600">Perbarui data siswa atas nama <strong>{{ $siswa->nama }}</strong>.</p>
        </div>
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                ...
                <div class="md:col-span-3">
                    <label for="kelas_id" class="block text-sm font-medium leading-6 text-gray-900">Kelas <span class="text-red-600">*</span></label>
                    <div class="mt-2">
                ...
                <div class="md:col-span-2">
                    <label for="nis" class="block text-sm font-medium leading-6 text-gray-900">NIS (Lokal) <span class="text-red-600">*</span></label>
                    <div class="mt-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mt-2">
                        <select id="status_mukim" name="status_mukim"
                            ...
                            {{-- Jika ada status Lulus, tampilkan, tapi jangan jadi opsi utama --}}
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="ttl_ayah" id="ttl_ayah" value="{{ old('ttl_ayah', $siswa->ttl_ayah) }}"
                           placeholder="Contoh: Jakarta, 01-01-1980"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
                <div class="md:col-span-3">
                    <label for="pendidikan_ayah" class="block text-sm font-medium leading-6 text-gray-900">Pendidikan Ayah</label>
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="email" name="email_ayah" id="email_ayah" value="{{ old('email_ayah', $siswa->email_ayah) }}"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
            </div>
            <!-- Data Ibu -->
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="ttl_ibu" id="ttl_ibu" value="{{ old('ttl_ibu', $siswa->ttl_ibu) }}"
                           placeholder="Contoh: Bandung, 02-02-1982"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
                <div class="md:col-span-3">
                    <label for="pendidikan_ibu" class="block text-sm font-medium leading-6 text-gray-900">Pendidikan Ibu</label>
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="email" name="email_ibu" id="email_ibu" value="{{ old('email_ibu', $siswa->email_ibu) }}"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
            </div>
        </div>
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="nama_wali" id="nama_wali" value="{{ old('nama_wali', $siswa->nama_wali) }}"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
                <div class="md:col-span-3">
                    <label for="ttl_wali" class="block text-sm font-medium leading-6 text-gray-900">Tempat, Tanggal Lahir Wali</label>
                    <input type="text" name="ttl_wali" id="ttl_wali" value="{{ old('ttl_wali', $siswa->ttl_wali) }}"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
                <div class="md:col-span-3">
                 ...
                 <div class="md:col-span-6">
                    ...
                    <textarea id="alamat_wali" name="alamat_wali" rows="3"
                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">{{ old('alamat_wali', $siswa->alamat_wali) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                <div class="md:col-span-6">
                    ...
                    <textarea id="alamat_orangtua" name="alamat_orangtua" rows="3"
                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">{{ old('alamat_orangtua', $siswa->alamat_orangtua) }}</textarea>
                </div>
                <div class="md:col-span-3">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="kodepos" id="kodepos" value="{{ old('kodepos', $siswa->kodepos) }}"
                           class="block w-full border-0 border-b-2 border-gray-200 bg-gray-50 px-3 py-1.5 focus:border-green-600 focus:ring-0 sm:text-sm">
                </div>
            </div>
        </div>
