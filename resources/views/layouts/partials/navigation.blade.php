    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
        <li>
            <ul role="list" class="-mx-2 space-y-1">
                {{-- 1. DASBOR (Boleh dilihat semua user) --}}
                <li>
                    <a href="{{ route('home') }}"
        ...
        <li>
            {{-- RBAC: Sembunyikan heading "DATA SEKOLAH" jika user tidak punya izin APAPUN di bawahnya --}}
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                {{-- RBAC: Hanya tampilkan jika user punya izin 'manage siswa' --}}
                @can('manage siswa')
                    {{-- 2. DATA SISWA --}}
                ...
                {{-- RBAC: Hanya tampilkan jika user punya izin 'manage guru' --}}
                @can('manage guru')
                    {{-- 3. DATA GURU --}}
                    <li>
                ...
                {{-- RBAC: Hanya tampilkan jika user punya izin 'manage kelas' --}}
                @can('manage kelas')
                ...
                {{-- RBAC: Hanya tampilkan jika user punya izin 'manage mapel' --}}
                @can('manage mapel')
                    {{-- 5. DATA MAPEL --}}
                    <li>
                ...
                {{-- RBAC: Hanya tampilkan jika user punya izin 'manage ekskul' --}}
                @can('manage ekskul')
                    {{-- 6. EKSKUL --}}
                    <li>
            ...
            {{-- RBAC: Sembunyikan heading "DATA AKADEMIK" jika user tidak punya izin 'view jadwal' --}}
            {{-- (Tambahkan izin lain ke 'canany' ini jika Anda menambah menu baru di bawah) --}}
            ...
            <ul role="list" class="-mx-2 mt-0 space-y-1 ">
                {{-- RBAC: Hanya tampilkan jika user punya izin 'view jadwal' --}}
                @can('view jadwal')
                    {{-- 7. DATA JADWAL --}}
                    <li>
                ...
                <li>
                    <a href="{{ route('agenda.index') }}"
                       class="{{ request()->routeIs('agenda.*') ? 'bg-green-700 text-white' : 'text-gray-400 hover:text-white hover:bg-green-700' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
