<div>
    {{-- 
      Ini adalah komponen Livewire yang baru.
      Semua HTML dari file index.blade.php lama Anda (yang Anda berikan)
      dipindahkan ke sini.
    --}}
        ...
        <div class="flex items-center space-x-3 w-full">
            <div class="flex-grow max-w-sm">
                ...
                {{-- 
                  ...
                  - Ini akan otomatis mencari 300ms setelah Anda berhenti mengetik.
                --}}
                <input type="text" 
            ...
            {{-- Tombol "Cari" sudah tidak diperlukan karena pencarian sekarang real-time --}}

            {{-- PERUBAHAN: Tombol Reset dihubungkan ke wire:click --}}
            <button type="button"
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <table class="min-w-full">
                    ...
                    <tbody class="text-gray-700">
                        @forelse($siswa as $s)
                            {{-- wire:key penting untuk Livewire --}}
                            <tr wire:key="siswa-{{ $s->id }}">
                                ...
                                <td class="border-t border-gray-200 px-3 py-5 text-sm whitespace-nowrap">
                                    {{ $s->kelas?->tingkat ?? '' }} - {{ $s->kelas?->nama_kelas ?? 'N/A' }}
                                </td>
                                <td class="border-t border-gray-200 px-3 py-5 text-sm whitespace-nowrap">
                                ...
                                <td class="border-t border-gray-200 px-3 py-5 text-sm whitespace-nowrap">
                                    ...
                                    @elseif($s->status_mukim == 'PP') {{-- Diubah dari NON MUKIM ke PP agar sesuai form --}}
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="border-t border-gray-200 py-8 text-center text-gray-500">
                                    @if($search)
                                        Siswa dengan nama atau NIS "{{ $search }}" tidak ditemukan.
                                    @else
