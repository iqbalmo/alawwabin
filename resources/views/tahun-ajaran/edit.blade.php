...
@section('title', 'Edit Tahun Ajaran | SITU Al-Awwabin')
...
@section('content')
    ...
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold tracking-tight text-[#2C5F2D]">Edit Tahun Ajaran</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden max-w-2xl">
        ...
        <form action="{{ route('tahun-ajaran.update', $tahunAjaran->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama"
                    value="{{ old('nama', $tahunAjaran->nama) }}" placeholder="Contoh: 2024/2025"
