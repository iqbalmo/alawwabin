...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-[#2C5F2D] mb-6">Edit Jadwal Pelajaran</h2>
    ...
    <form action="{{ route('jadwal.update', $jadwal->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            <div>
                ...
                <input type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai', $jadwal->jam_mulai) }}" class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-gray-900 shadow-sm focus:outline-none focus:ring-[#C8963E] focus:border-[#C8963E] sm:text-sm" required>
            ...
            <div>
                ...
                <input type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai', $jadwal->jam_selesai) }}" class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-gray-900 shadow-sm focus:outline-none focus:ring-[#C8963E] focus:border-[#C8963E] sm:text-sm" required>
