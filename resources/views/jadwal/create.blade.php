...
@section('title', 'Tambah Jadwal Baru | SIAP Al-Awwabin')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h2 class="text-2xl font-bold text-[#2C5F2D]">Tambah Jadwal Pelajaran</h2>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form action="{{ route('jadwal.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <input type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai') }}" class="block w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#2C5F2D] focus:border-transparent sm:text-sm" required>
            ...
            <div>
                ...
                <input type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai') }}" class="block w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#2C5F2D] focus:border-transparent sm:text-sm" required>
