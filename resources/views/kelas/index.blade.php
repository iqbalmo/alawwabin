...
<div class="mt-8 space-y-10">
                        ...
                        <table class="min-w-full">
                            <thead class="sticky top-0 bg-[#F0E6D2]">
                                <tr>
                                    ...
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-[#333333] uppercase tracking-wider">Jumlah Siswa</th>
    ...
    @empty
        <div class="border-t border-gray-200 py-8 text-center text-gray-500">
            ...
            <a href="{{ route('kelas.create') }}" class="text-sm font-medium text-[#C8963E] hover:text-[#b58937]">Tambah kelas baru.</a>
        </div>
    @endforelse
