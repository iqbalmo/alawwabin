...
@section('title', 'Edit Data Guru | SIAP Al-Awwabin')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-[#2C5F2D]">Edit Data Guru</h1>
        <p class="mt-1 text-sm text-gray-600">Perbarui informasi guru atau staf pengajar.</p>
    </div>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="gelar" id="gelar" value="{{ old('gelar', $guru->gelar) }}" placeholder="Contoh: S.Pd., M.Pd."
                               class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-2">
                        <textarea id="alamat" name="alamat" rows="3" 
                                  class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">{{ old('alamat', $guru->alamat) }}</textarea>
                    </div>
                </div>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $guru->jabatan) }}" placeholder="Contoh: Guru Mapel, Staf TU"
                               class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <select id="status_kepegawaian" name="status_kepegawaian" class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">
                            ...
                            <option value="Staf" {{ old('status_kepegawaian', $guru->status_kepegawaian) == 'Staf' ? 'selected' : '' }}>Staf / Karyawan</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="tahun_mulai_bekerja" id="tahun_mulai_bekerja" value="{{ old('tahun_mulai_bekerja', $guru->tahun_mulai_bekerja) }}" placeholder="Contoh: 2015"
                               class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-2">
                        <input type="text" name="pend_terakhir_tahun" id="pend_terakhir_tahun" value="{{ old('pend_terakhir_tahun', $guru->pend_terakhir_tahun) }}" placeholder="2010"
                               class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C8963E] sm:text-sm sm:leading-6">
                    </div>
                </div>
